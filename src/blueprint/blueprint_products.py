        ...
        for key, value in json_input.items():
            if key == 'products':
                for i in value:
                    ...
                    data = repo.create_new_product(param_product_id, param_product_value, param_company_id)
                ...
                for i in value:
                    for k, v in i.items():
                        if k == 'id':
                            ...
                            param_product_value = v
                    data = repo.update_product(param_company_id, param_product_id, param_product_value)
